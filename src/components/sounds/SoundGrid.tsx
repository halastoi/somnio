        ...
        <SidebarItem
          ...
          svgIcon={
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <circle cx="18" cy="4" r="1" fill="var(--text-muted)" />
              <circle cx="16" cy="6" r="1" fill="var(--text-muted)" />
              <circle cx="4" cy="16" r="1" fill="var(--text-muted)" />
              <circle cx="8" cy="16" r="1" fill="var(--text-muted)" />
              <circle cx="4" cy="18" r="1" fill="var(--text-muted)" />
              <circle cx="18" cy="18" r="1" fill="var(--text-muted)" />
            </svg>
          }
        />
      </div>
